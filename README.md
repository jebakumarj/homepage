...
![Dark theme](./asset/dark-theme.png)

![Light theme](./asset/light-theme.png)

Features:
- Welcome header with your name and current time & day
...
Context menu: right-click a card to open a context menu with **Edit** and **Delete** actions
